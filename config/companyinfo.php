...
<<<<<<< HEAD
    ...
    'address'     => env(
        'COMPANY_ADDRESS',
        "12 Floor, Phase II, TICEL BIO PARK,\nNO 5, CSIR Road,\nTaramani, Chennai - 600 113\nTamil Nadu, India"
    ),
    'signatory'   => env('COMPANY_SIGNATORY', 'Authorized Signatory'),

    // Invoice-specific fields
    'pan'         => env('COMPANY_PAN', 'AAAAA1234A'),
    'gst_no'      => env('COMPANY_GST_NO', '22AAAAA0000A1Z5'),
    'reference_no'=> env('COMPANY_REFERENCE_NO', 'REF-123456'),
    'lut_no'      => env('COMPANY_LUT_NO', 'LUT2024-25'),
