...
<div class="card">
  <div class="card-header">
    <div class="d-flex justify-content-between">
      <h4 class="text-dark bold mb-0">Currencies</h4>
      @can('create input output format')
        <a href="{{ route('currencies.create') }}" class="btn btn-primary btn-md" title="Add Currency">
          <i class="fa fa-plus me-2"></i>Add Currency
        </a>
      @endcan
    </div>
  </div>
...
<script>
  ...
  $(document).on("click", "#delete-currencies", function () {
    var id = $(this).data('id');
    Swal.fire({
