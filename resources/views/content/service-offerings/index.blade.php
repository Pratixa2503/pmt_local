...
<div class="card">
  <div class="card-header">
    <div class="d-flex justify-content-between">
      <h4 class="text-dark bold mb-0">Service Offering</h4>
      @can('create input output format')
        <a href="{{ route('service-offerings.create') }}" class="btn btn-primary btn-md" title="Add Service Offerings">
          <i class="fa fa-plus me-2"></i>Add Service Offering
        </a>
      @endcan
    </div>
  </div>
...
<script>
  ...
  processing: true,
  serverSide: true,
  ajax: '{!! route('service-offerings.index') !!}',
  ...
  columns: [
    ...
    { data: 'name',              name: 'service_offerings.name', responsivePriority: 2 },
    { data: 'department_name',   name: 'd.name',                 responsivePriority: 3 }, // NEW
    { data: 'industry_vertical', name: 'iv.name',                responsivePriority: 4 }, // NEW
    {
      data: 'actions',
      name: 'actions',
      orderable: false,
  ...
  $(document).on("click", "#delete-service-offering", function () {
    var id = $(this).data('id');
    Swal.fire({
      text: 'Are you sure you want to delete this Service offering?',
      icon: 'warning',
