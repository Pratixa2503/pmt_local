    ...
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h4 class="mb-0 text-dark bold">{{ __('Edit Project Priority') }}</h4>
            </div>
            <div class="card-body">
                <form id="deliveryFrequencyForm" method="POST"
                    action="{{ $type == 'create'
            ? route('project-priorities.store')
            : route('project-priorities.update', Crypt::encryptString($projectType->id)) }}"
                    ...
                    <div class="row">
                        <div class="justify-content-between text-end">
                            <a href="{{ route('project-priorities.index') }}" class="btn btn-info mx-1"><i class="ti ti-chevron-left me-sm-1 me-0 mb-1"></i>{{ __('Back') }}</a>
