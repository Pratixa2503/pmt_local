...
<div class="card">
    <div class="card-header">
        <div class="justify-content-between d-flex">
            <h4 class="text-dark bold mb-0">{{ __('Departments') }}</h4>
            <div>
                @can('create department')
                    <a href="{{ route('departments.create') }}" class="btn btn-primary btn-md" title="Add Department">
    ...
    $(function() {
        $('#department-table').DataTable({
            ...
            columns: [
                ...
                {
                data: 'industry_vertical',     // NEW
                name: 'iv.name',               // search/sort on joined table column
