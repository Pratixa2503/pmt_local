...
<div class="card">
  <div class="card-header">
    <div class="d-flex justify-content-between">
      <h4 class="text-dark bold mb-0">Unit Of Measurements</h4>
      @can('create input output format')
        <a href="{{ route('unit-of-measurements.create') }}" class="btn btn-primary btn-md" title="Add Service Offerings">
          <i class="fa fa-plus me-2"></i>Add Unit Of Measurement
        </a>
      @endcan
    </div>
  </div>
...
<script>
  ...
  $(function () {
    $('#input-output-format-table').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: '{!! route("unit-of-measurements.index") !!}',
  ...
  $(document).on("click", "#delete-unit-of-measurement", function () {
    var id = $(this).data('id');
    Swal.fire({
      text: 'Are you sure you want to delete this Unit Of Measurement?',
      icon: 'warning',
