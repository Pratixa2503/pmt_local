            ...
            <div class="card-body">
                <form id="formatForm" method="POST" action="{{ 
                    $type == 'create' 
                        ...
                        : route('unit-of-measurements.update', Crypt::encryptString($data->id)) 
                }}">
                    @csrf
                    ...
                    <div class="text-end">
                        <a href="{{ route('unit-of-measurements.index') }}" class="btn btn-secondary"><i class="ti ti-chevron-left me-sm-1 me-0 mb-1"></i>{{ __('Back') }}</a>
