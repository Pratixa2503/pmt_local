...
<div class="card">
  <div class="card-header">
    <div class="d-flex justify-content-between">
      <h4 class="text-dark bold mb-0">Skills</h4>
      @can('create skill master')
        <a href="{{ route('skill-masters.create') }}" class="btn btn-primary btn-md" title="Add Service Offerings">
...
<script>
  ...
  $(function () {
    $('#input-output-format-table').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: '{!! route('skill-masters.index') !!}',
  ...
  $(document).on("click", "#delete-skill-master", function () {
    var id = $(this).data('id');
    Swal.fire({
