...
<div class="card">
    ...
    <div class="justify-content-between d-flex">
        <h4 class="text-dark bold mb-0">{{ __('Project Types') }}</h4>
        <div class="justify-content-between">
            @if( auth()->check() && auth()->user()->can('create project type') )
                <a href="{{ route('project-types.create') }}" class="btn btn-primary btn-md" data-toggle="tooltip" title="Add Project Type"><i class="fa fa-plus me-2"></i>{{ __('Add Project Type') }}</a>
            @endif
        </div>
    </div>
    </div>
    ...
    <script>
        ...
        $(function() {
            $('#projecttype-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{!! route('project-types.index') !!}',
