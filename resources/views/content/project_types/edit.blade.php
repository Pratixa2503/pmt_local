...
@section('content')
    {{-- <x-breadcrumb :items="['home' => 'Roles and Permissions', 'icon' => 'menu-icon tf-icons ti ti-user-check', 'name' => 'Permissions', 'subname' => 'Edit Permission']" /> --}}
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 text-dark bold">{{ __('Edit Project Type') }}</h4>
                </div>
                <div class="card-body">
                    <form id="createForm" method="POST" action="{{ route('project-types.update', Crypt::encryptString($projectType->id)) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
