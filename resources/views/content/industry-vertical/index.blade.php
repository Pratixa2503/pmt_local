...
@section('title', 'Industry Verticals')
...
<div class="card">
  <div class="card-header">
    <div class="d-flex justify-content-between">
      <h4 class="text-dark bold mb-0">Industry Verticals</h4>
      @can('create input output format')
        <a href="{{ route('industry-verticals.create') }}" class="btn btn-primary btn-md" title="Add Industry Vertical">
          <i class="fa fa-plus me-2"></i>Add Industry Vertical
        </a>
      @endcan
    </div>
  </div>
...
<script>
  ...
  $(function () {
    $('#input-output-format-table').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: '{!! route('industry-verticals.index') !!}',
  ...
  $(document).on("click", "#industry-vertical", function () {
    var id = $(this).data('id');
    Swal.fire({
      text: 'Are you sure you want to delete this Industry Verticals?',
      icon: 'warning',
