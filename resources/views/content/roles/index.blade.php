...
<div class="card">
    ...
    <div class="justify-content-between d-flex">
        <h4 class="text-dark bold mb-0">{{ __('Roles List') }}</h4>
        <div class="justify-content-between">
            {{-- @if(Helper::checkPermission('create_hospital')) --}}
                {{-- <a href="{{ route('roles.create') }}" class="btn btn-primary btn-md" data-toggle="tooltip" title="Add Role"><i class="fa fa-plus me-2"></i>{{ __('Add Role') }}</a> --}}
            {{-- @endif --}}
        </div>
    </div>
    </div>
    ...
    <div class="card-body">
        <div class="table-responsive text-nowrap">
            ...
            <table class="common-datatable table" id="roles-table">
                <thead>
                    <tr>
                        <th></th>
                        <!-- <th width="10%">ID</th> -->
