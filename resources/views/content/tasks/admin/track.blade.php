...
<<<<<<< HEAD
  <div class="col-xl-12 col-lg-11 mx-auto">
    <div class="card shadow-sm">
      <div class="card-header sticky-top-lite d-flex justify-content-between align-items-center">
        <div>
          <h4 class="text-dark mb-0">Admin Tracking — {{ $project->project_name }}</h4>
          <div class="small text-muted">Today ({{ $todayDateLocal }}) · {{ $appTz }}</div>
        </div>
  ...
  <div class="col-md-3">
    <label class="form-label mb-0">Filter by User</label>
