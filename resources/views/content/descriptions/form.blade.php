            ...
            <div class="card-body">
                <form id="formatForm" method="POST" action="{{ 
                    $type == 'create' 
                        ...
                        : route('descriptions.update', Crypt::encryptString($data->id)) 
                }}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                                   id="name" name="name" value="{{ old('name', $data->name ?? '') }}" placeholder="Enter Description" autofocus>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @php
                                // Default to 1 (Active) when creating; keep old() or $data->status on edit/validation error
                    ...
                    <div class="text-end">
                        <a href="{{ route('descriptions.index') }}" class="btn btn-secondary"><i class="ti ti-chevron-left me-sm-1 me-0 mb-1"></i>{{ __('Back') }}</a>
