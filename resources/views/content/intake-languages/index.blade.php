...
@section('title', $title ?? 'Intake Languages')
...
<div class="card">
  <div class="card-header">
    <div class="d-flex justify-content-between">
      <h4 class="text-dark mb-0">{{ __('Intake Languages') }}</h4>
      <div>
        @can('create intake language')
          <a href="{{ route('intake-languages.create') }}" class="btn btn-primary btn-md" data-toggle="tooltip" title="Add Language">
  ...
  <div class="card-body">
    <div class="table-responsive text-nowrap">
      <table class="common-datatable table" id="languages-table">
        <thead>
          <tr>
            <th></th>
            <th>Name</th>
...
<script>
  ...
  $(function() {
    const table = $('#languages-table').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: '{!! route('intake-languages.index') !!}',
    ...
    // Delete
    $(document).on('click', '.delete-intake-language', function() {
