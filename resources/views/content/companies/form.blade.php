...
<<<<<<< HEAD
      ...
      $wrapper.trigger('row:added', [ $wrapper.find('.team-row:last') ]);
      updateRowButtons();
    });
...
<<<<<<< HEAD
    ...
    function updateRowButtons() {
      $('.team-row .btn-slot').each(function(i){
        ...
        if (i > 0) $(this).append('<button type="button" class="btn btn-danger remove-row">-</button>');
      });
    }
    updateRowButtons();
...
<<<<<<< HEAD
    ...
    function bindTeamRowValidation($row) {
      ...
      $first.rules('add', { required: true, maxlength: 100, messages: { required: "Enter first name." }});
      $last.rules('add',  { required: true, maxlength: 100, messages: { required: "Enter last name." }});
      $phone.rules('add', { required: true, optionalPhone: true, maxlength: 50 });
      $email.rules('add', { required: true, email: true, maxlength: 255, messages: { required: "Enter email." }});
      $status.rules('add',{ required: true });
...
=======
            ...
            <div class="col-md-3"><label class="form-label">Email <span class="text-danger">*</span></label></div>
            <div class="col-md-1"><label class="form-label">Status</label></div>
...
<<<<<<< HEAD
    ...
    <div class="mb-3 col-md-2 form-group">
      <input type="text" name="team[__IDX__][contact_no]" class="form-control contact-no" placeholder="Phone" required>
    </div>
    <div class="mb-3 col-md-2 form-group">
