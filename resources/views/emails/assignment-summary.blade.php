@php
  ...
  // Optional: deep link to your dashboard or listing page
  $ctaUrl = $dashboardUrl ?? url('/'); 
@endphp
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
<title>{{ $brand }} — Assignments Summary</title>
          ...
          <tr>
            <td class="card" style="padding:28px 28px 8px 28px;">
              ...
              <p style="margin:0 0 18px 0; font-size:14px; color:#555;">
                You have {{ $count }} new assignment{{ $count === 1 ? '' : 's' }} from the latest import.
              </p>
              ...
              @else
                <p style="margin:0 0 16px 0; font-size:14px; color:#6B7280;">No items available.</p>
              @endif
              ...
              <p style="margin:0 0 24px 0; font-size:12px; color:#97999B;">
                ...
                <span style="word-break:break-all; color:#555;">{{ $ctaUrl }}</span>
              </p>
            </td>
          </tr>
