...
<head>
<meta charset="utf-8">
<title>{{ $brand }} — Abstraction Completed</title>
          ...
          <tr>
            <td class="card" style="padding:28px 28px 8px 28px;">
              <h1 style="margin:0 0 12px 0; font-size:20px; font-weight:700; color:#111827;">
                Abstraction Completed ({{ $count }})
              </h1>
              <p style="margin:0 0 18px 0; font-size:14px; color:#555;">
                The abstractor has marked the following item(s) complete.
              </p>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" align="left" style="margin:0 0 24px 0;">
                <tr>
                  <td>
                    <a href="{{ $dashboardUrl ?? url('/') }}" class="cta"
              ...
              <p style="margin:0 0 24px 0; font-size:12px; color:#97999B;">
                ...
                <span style="word-break:break-all; color:#555;">{{ $dashboardUrl ?? url('/') }}</span>
              </p>
            </td>
          </tr>
