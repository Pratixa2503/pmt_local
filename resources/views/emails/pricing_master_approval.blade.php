...
<head>
<meta charset="utf-8">
<title>{{ $brand }} — Pricing Approval</title>
          ...
          <tr>
            <td class="card" style="padding:28px 28px 8px 28px;">
              <h1 style="margin:0 0 12px 0; font-size:20px; font-weight:700; color:#111827;">
                Approval Needed: Pricing Master #{{ $pricing->id }}
              </h1>
              <p style="margin:0 0 18px 0; font-size:14px; color:#555;">A new Pricing Master is awaiting your review.</p>
                    ...
                    <table width="100%">
                      ...
                      <tr>
                        <td colspan="2" style="font-size:14px; color:#111827; padding:6px 0;">
                          ...
                          @if(!empty($serviceOfferingNames))
                            {{ implode(', ', $serviceOfferingNames) }}
                          @else
                            N/A
                          @endif
                        </td>
                      ...
                      <tr>
                        <td style="font-size:14px; color:#111827; padding:6px 0;">
                          <strong>Type:</strong> {{ $pricing->pricing_type ?? 'N/A' }}
                        </td>
                        <td style="font-size:14px; color:#111827; padding:6px 0;">
                          <strong>Submitted:</strong> {{ $pricing->submitted_at }}
                        </td>
                      </tr>
                    </table>
                  </td>
