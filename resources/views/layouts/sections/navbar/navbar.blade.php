...
<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
        ...
        <div class="nav-item navbar-search-wrapper mb-0">
            <span class="d-none d-md-inline-block text-muted">
                @if (!empty(Request::segment(2)))
                    <!-- <h5 class="mb-0">{{ __(ucwords(preg_replace('/[-_]/', ' ', Request::segment(2)))) }} </h5> -->
                @else
                    <h5 class="mb-0">{{ __(ucwords(str_replace('-', ' ', Request::segment(1)))) }}</h5>
                @endif
            </span>
        </div>
    </div>
    ...
    <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <!--/ Notification -->
        @php
            $firstInitial = strtoupper(substr(Auth::user()->first_name, 0, 1));
            $lastInitial = strtoupper(substr(Auth::user()->last_name, 0, 1));
        ...
        <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                <div class="avatar avatar-online">
                    <img src="https://placehold.co/400x400/E35205/white?text={{ $initials }}" alt class="h-auto rounded-circle">
                </div>
            </a>
                ...
                <li>
                    <a class="dropdown-item" href="{{ url('pages/profile-user') }}">
                        <div class="d-flex">
                            <div class="flex-shrink-0 me-3">
                                <div class="avatar avatar-online">
                                    <img src="https://placehold.co/400x400/E35205/white?text={{ $initials }}"
