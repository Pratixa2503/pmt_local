...
class DocumentAlertMail extends Mailable
{
     ...
     */
    public function __construct(Document $document, DocumentAlert $alert, DocumentContract $contract, int $daysUntilStart)
    {
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: "Document Contract Start Date Alert - {$customerName}",
        );
    }
