...
class ServiceOfferingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ServiceOffering::create(array_merge($request->all(),['created_by' => auth()->id(),'updated_by'=>auth()->id()]));
    ...
    public function update(Request $request, $id)
    {
        ...
        ServiceOffering::findOrFail($id)->update(array_merge($request->all(),['updated_by'=>auth()->id()]));
