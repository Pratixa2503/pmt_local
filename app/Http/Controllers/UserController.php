...
class UserController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('content.users.create', compact('roles', 'title', 'pm_users'));
    }
       ...
       $query = User::query()
        ...
        return DataTables::of($query)
            ...
            ->addColumn('actions', function ($user) {
                ...
                $deleteBtn = '<a href="javascript:void(0)" id="delete-user" data-id="'.$user->id.'"><i class="fa fa-trash"></i></a>';
